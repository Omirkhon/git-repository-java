...
public class Practice {
    ...
    public static final String mapLink = "https://recyclemap.kz/";
    ...
    public static void main(String[] args) {
        ...
        if (commandValue.equalsIgnoreCase("map")) {
            System.out.println(mapLink);
        } else if (commandValue.equalsIgnoreCase("recyclability")) {
            System.out.print("Введите код переработки: ");
            int code = scanner.nextInt();
            isRecycled(code);
        } else if (commandValue.equalsIgnoreCase("bonus")) {
